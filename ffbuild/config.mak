...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=aarch64 --enable-cross-compile --target-os=android --cross-prefix=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- --cc=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang --cxx=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang++ --ar=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar --nm=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm --ranlib=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib --strip=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip --x86asmexe=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/yasm --disable-avdevice --disable-debug --disable-doc --disable-programs --disable-static --enable-shared
prefix=/usr/local
...
CC_IDENT=Android (12470979, +pgo, +bolt, +lto, +mlgo, based on r522817c) clang version 18.0.3 (https://android.googlesource.com/toolchain/llvm-project d8003a456d14a3deb8054cdaa529ffbf02d9b262)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=
CC=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
CXX=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang++
AS=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
OBJCC=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
LD=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
DEPCC=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPCXX=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
DEPCXXFLAGS= $(CPPFLAGS)
DEPAS=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android35-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/yasm
DEPX86ASM=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/yasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
ARFLAGS=rcD
RESPONSE_FILES=yes
AR_O=$@
AR_CMD=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
NM_CMD=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib -D
STRIP=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
...
LD_PATH=-L
DLLTOOL=
WINDRES=/workspace/ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-windres
DOXYGEN=doxygen
